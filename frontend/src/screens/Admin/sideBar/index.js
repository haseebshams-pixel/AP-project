      ...
      <Logo>
        ...
        <SlickBar clicked={click}>
          ...
          <Item
            onClick={() => setClick(false)}
            activeClassName="active"
            to="/adminhome/student"
          >
            <img src={Student} alt="Team" />
            <Text clicked={click}>Student</Text>
          </Item>
          <Item
            onClick={() => setClick(false)}
            exact
            activeClassName="active"
            to="/adminhome/teacher"
          >
            <img src={Teacher} alt="Home" />
            <Text clicked={click}>Teacher</Text>
          </Item>
        </SlickBar>
